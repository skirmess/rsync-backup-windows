...
C:\cygwin\bin\rsync.exe --archive --verbose --modify-window=1 %linkArgument% --exclude-from=/cygdrive/%driveLetter%/backup/backup_exclude.txt /cygdrive/c/kirmess /cygdrive/c/users /cygdrive/%driveLetter%/backup/%bdir%
